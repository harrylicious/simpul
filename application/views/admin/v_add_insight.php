...
<head>
  ...
  <title>SIMPUL-NTB | Tambah Insight</title>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Post Insight</h3>
        </div>

		<form action="<?php echo base_url().'admin/insight/save_insight'?>" method="post" enctype="multipart/form-data">

        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
              <input type="text" name="xjudul" class="form-control" placeholder="Judul Insight" required/>
            </div>
            <!-- /.col -->
            <div class="col-md-2">
