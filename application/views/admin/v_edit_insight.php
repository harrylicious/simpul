...
<head>
  ...
  <title>SIMPUL-NTB | Edit Insight</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Update Insight</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Update Insight</h3>
        </div>
		<?php
        $b=$data->row_array();
    ?>
		<form action="<?php echo base_url().'admin/insight/update_insight'?>" method="post" enctype="multipart/form-data">

        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
              <input type="hidden" name="kode" value="<?php echo $b['id_insight'];?>">
              <input type="text" name="xjudul" class="form-control" value="<?php echo $b['judul'];?>" placeholder="Judul Insight" required/>
            </div>
            <!-- /.col -->
            <div class="col-md-2">
                  ...
                  <option value="">-Pilih-</option>
        				  <?php
        					foreach ($kat->result_array() as $i) {
                               $kategori_id=$i['id_kategori_insight'];
                               $kategori_nama=$i['kategori'];
                               if($b['id_kategori_insight']==$kategori_id)
