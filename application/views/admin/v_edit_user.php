                    ...
                    <div class="box-body">
                        ...
                        <form action="<?= base_url('admin/user/update_data'.'/'.$data['kode_user']); ?>" method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Kode UK UP</label>
                                        <input type="text" class="form-control" id="kode_uk_up" name="kode_uk_up" placeholder="Kode UK UP" value="<?= $data['kode_uk_up']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Wilayah</label>
                                        <input type="text" class="form-control" id="wilayah" name="wilayah" placeholder="Wilayah" value="<?= $data['wilayah']; ?>" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="instansi" name="instansi" placeholder="Instansi" value="<?= $data['instansi']; ?>">
                                    </div>
                                </div>
