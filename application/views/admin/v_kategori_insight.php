      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <a class="btn btn-success btn-flat" data-toggle="modal" onClick="add_kategori()"><span class="fa fa-plus"></span> Tambah Kategori Insight</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <input type="hidden" name="id_kategori_insight">
    ...
    $(function () {
        if ($('.datatable').length) {
            datatable = $('.datatable').DataTable({
                ...
                "ajax": {
                    "url": '<?= base_url('admin/kategoriinsight/datatables_kategori') ?>',
                    "type": "POST"
                },
                "columns": [
