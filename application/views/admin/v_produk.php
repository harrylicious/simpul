...
<head>
  ...
  <title>SIMPUL-NTB | Daftar produk</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/produk/tambah'?>"><span class="fa fa-plus"></span> Tambah produk</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    $(function () {
        if ($('.datatable').length) {
            datatable = $('.datatable').DataTable({
                ...
                "ajax": {
                    "url": '<?= base_url('admin/produk/datatables/') ?>',
                    "type": "POST"
                },
                "columns": [
