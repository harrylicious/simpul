  ...
  <div class="col-md-3">
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <a href="<?= base_url('admin/document/tambah'); ?>" class="btn btn-primary btn-block"><b>Segarkan</b></a>
                        ...
                        <form action="<?= base_url('admin/document/save_data'); ?>" method="post">
                            <div class="row">
                                <div class="col-sm-12 ">
                                    <div class="form-group">
                                        <label>Nama Lengkap <?php echo  $data['nama_lengkap']; ?> </label>
                                        <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" placeholder="Nama Lengkap" value="<?= $data['nama_lengkap']; ?>" readonly>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Desa</label>
                                        <input type="text" class="form-control" id="desa" name="desa" placeholder="Desa" value="<?= $data['desa']; ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="kecamatan" name="kecamatan" placeholder="Kecamatan" value="<?= $data['kecamatan']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Kabupaten</label>
                                        <input type="text" class="form-control" id="kabupaten" name="kabupaten" placeholder="Kabupaten" value="<?= $data['kabupaten']; ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Telpon</label>
                                        <input type="text" class="form-control" id="telpon" name="telpon" placeholder="Telpon" value="<?= $data['telp']; ?>" readonly>
                                    </div>
                                </div>
                            </div>
