            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div class="courses_box mb-2" >
                    <div class="course-img-wrap" >
                       ...
                       <img src="<?= base_url('assets/images/products/thumbnail/'.$row->photo); ?>" onerror="this.src='<?= base_url('assets/images/no-image.jpg'); ?>'" class="img-fluid" alt="<?= $row->slug ?>" style="height: 260px; width:100%; object-fit: cover; object-position:center; o-object-fit: cover; o-object-position:center">
                    </div>
                    <!-- // end .course-img-wrap -->
                    <a href="<?php echo site_url('produk/'.$row->slug);?>" class="course-box-content">
                        <h4 style="text-align:center;text-style:bold"><b><?= $row->nama_produk ?></b></h4>
                        <center><span class="badge badge-primary text-center"><?= $row->nama_usaha ?></span></center>
                    </a>
                </div>
            </div>
          <?php endforeach;?>
