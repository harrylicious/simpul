...
<section class="blog-wrap" style="margin-top: 5%;"> 
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="blog-tiltle_block">
                    <h4><a href="<?php echo site_url('produk/'.$slug);?>"><?php echo $nama;?></a></h4>
                    <h6> <a href="#"><i class="fa fa-user" aria-hidden="true"></i><span><?php echo $usaha;?></span> </a></span></a></h6>
                    <?php echo $deskripsi;?>
                </div>
                    ...
                    <div class="blogpost-tabs">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="write-comment" role="tabpanel">
                                <form action="<?php echo site_url('produk/komentar');?>" method="post">
                                    <div class="row">
                                        <div class="col-6">
                ...
                <div class="blog-category_block">
                    ...
                    <ul>
                      <?php foreach ($kategori as $row) : ?>
                        <li><a href="<?php echo site_url('produk/kategori/'.str_replace(" ","-",$row->kategori));?>"><?php echo $row->kategori;?><span>(<?php echo $row->Total;?>)</span><i class="fa fa-caret-right" aria-hidden="true"></i></a></li>
                      <?php endforeach;?>
                    </ul>
                </div>
                <div class="blog-featured_post">
                  ...
                  <?php foreach ($populer->result() as $row) :?>
                    <div class="blog-featured-img_block">
                        <img width="35%" src="<?php echo base_url().'assets/images/'.$row->photo;?>" class="img-fluid" alt="blog-featured-img">
                        <h5><a href="<?php echo site_url('produk/'.$row->slug);?>"><?php echo limit_words($row->nama_produk,3).'...';?></a></h5>
                        <p><?php echo limit_words($row->deskripsi,5).'...';?></p>
                    </div>
                    <hr>
                  <?php endforeach;?>
                </div>
